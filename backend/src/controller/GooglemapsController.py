...
class MapsController:
    ...
    def calcular_percurso(self, data):
        ...
        try:
            ...
            directions_result = self.gmaps.directions(data.get('origem'),
                                                      data.get('destino'),
                                                      mode="driving",
                                                      departure_time=now)
    ...
    def ponto_em_raio(self, data, raio):
        print("Origem:", data.get('origem'))
        print("Destino:", data.get('destino'))
        print("Raio:", raio)
...
if __name__ == '__main__':
    ...
    response_percurso = maps_controller.calcular_percurso(origem, destino)
    print("Resposta do método calcular_percurso:", response_percurso)

    # Chama o método ponto_em_raio
    response_raio = maps_controller.ponto_em_raio(origem, destino, raio)
    print("Resposta do método ponto_em_raio:", response_raio)
